    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 md:gap-0 mb-6">
        ...
        <div className="flex flex-wrap w-full md:w-auto gap-2">
          ...
          <button className="bg-white border border-gray-300 rounded-md px-2 md:px-3 py-1.5 md:py-2 text-xs md:text-sm font-medium text-gray-700 hover:bg-gray-50 flex items-center space-x-1 flex-shrink-0">
            <Filter size={14} className="md:block" />
            <span>Filtrar</span>
          </button>
          
          <div className="flex rounded-md overflow-hidden border border-gray-300 ml-auto md:ml-0 flex-shrink-0">
            <button
              onClick={() => setViewMode('list')}
              className={`px-2 md:px-3 py-1.5 md:py-2 text-xs md:text-sm ${
                viewMode === 'list' 
